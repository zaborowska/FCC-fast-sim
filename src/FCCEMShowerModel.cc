...
//
//
// based on G4 examples/extended/arametrisations/Par01/src/Par01EMShowerModel.cc
//
...
// If there are spots outside the detector, delete them, add up their energy and recreate the mother particle with given energy at detector boundary
// Don't know how easy to implement
