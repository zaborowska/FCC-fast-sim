...
// ********************************************************************
//
// based on G4 examples/basic/B5/src/B5HadCalorimeterSD.cc
//
...
FCCHadCalorimeterSD::FCCHadCalorimeterSD(G4String name)
...
FCCHadCalorimeterSD::~FCCHadCalorimeterSD()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void FCCHadCalorimeterSD::Initialize(G4HCofThisEvent* hce)
{
    fHitsCollection
      = new FCCHadCalorimeterHitsCollection(SensitiveDetectorName,collectionName[0]);
    if (fHCID<0)
    ...
    for (G4int iColumn=0;iColumn<10;iColumn++)
        ...
        {
            FCCHadCalorimeterHit* hit = new FCCHadCalorimeterHit();
...
G4bool FCCHadCalorimeterSD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
    ...
    FCCHadCalorimeterHit* hit = (*fHitsCollection)[hitID];
