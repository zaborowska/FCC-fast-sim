...
FCCPrimaryParticleInformation::FCCPrimaryParticleInformation(G4LorentzVector* vertex, G4LorentzVector* momentum)
{
   vertexProduction = new G4LorentzVector(*vertex);
   momentumProduction = new G4LorentzVector(*momentum);
}

FCCPrimaryParticleInformation::FCCPrimaryParticleInformation(G4double x, G4double y, G4double z, G4double t, G4double Px, G4double Py, G4double Pz, G4double E)
{
...
G4LorentzVector* FCCPrimaryParticleInformation::GetVertexProduction()
{
   return vertexProduction;
}

G4LorentzVector* FCCPrimaryParticleInformation::GetMomentumProduction()
{
