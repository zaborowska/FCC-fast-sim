...
// ********************************************************************
//
// based on G4 examples/basic/B5/src/B5EmCalorimeterHit.cc
//
...
G4ThreadLocal G4Allocator<FCCEmCalorimeterHit>* FCCEmCalorimeterHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

FCCEmCalorimeterHit::FCCEmCalorimeterHit()
: G4VHit(), fCellID(-1), fEdep(0.), fPos(0), fPLogV(0)
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

FCCEmCalorimeterHit::FCCEmCalorimeterHit(G4int z)
...
FCCEmCalorimeterHit::FCCEmCalorimeterHit(const FCCEmCalorimeterHit &right)
: G4VHit() {
...
const FCCEmCalorimeterHit& FCCEmCalorimeterHit::operator=(const FCCEmCalorimeterHit
                                                          &right)
{
    fCellID = right.fCellID;
    fEdep = right.fEdep;
...
int FCCEmCalorimeterHit::operator==(const FCCEmCalorimeterHit &right) const
{
...
const std::map<G4String,G4AttDef>* FCCEmCalorimeterHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("FCCEmCalorimeterHit",isNew);
...
std::vector<G4AttValue>* FCCEmCalorimeterHit::CreateAttValues() const
{
...
void FCCEmCalorimeterHit::Print()
{
